...
def replace_detailed_analysis():
    # Replace the generate_detailed_analysis function prompt
    ...
    # We will just replace the prompt string inside it
    prompt_str = """
            prompt = f\"\"\"
            ...
            {'- DO NOT USE ANY ENGLISH WORDS except for technical terms if absolutely necessary.' if target_lang.lower() != 'english' else ''}
...
new_content = replace_detailed_analysis()

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(new_content)
print("Updated Expert Analysis prompt")
